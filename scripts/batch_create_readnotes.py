...
def batch_create_readnotes():
    ...
    book_name = "2025090Artificial_Intelligence_The_Basics"
    default_content = "Kevin Warwick.(2012).2025090Artificial_Intelligence_The_Basics.Routledge => Introduction"
